...
function Configure (originalCLIArguments) {
  ...
  var wpOpt = this.wpOpt = convertArgv(SIMULATE_OPTIMIST, SIMULATE_ARGV, {
    outputFilename: "/bundle.js"
  });
  this.originalCLIArguments = originalCLIArguments = originalCLIArguments || {};
  var options = this.options = wpOpt.devServer || {};
...
var configurePrototype = Configure.prototype;
